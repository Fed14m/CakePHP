...
import BlogDetailsContent from '../page-sections/blog/BlogDetailsContent'
...
class BlogDetails extends PureComponent {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
        <div ref={this.homeRoot} className="home-root"
          ...
          />
          <BlogDetailsContent visibleHeight={this.props.match.winDimen} />
          <FooterSection
