...
import HeroNav from '../page-sections/learn/HeroNav'
import DataSection from '../page-sections/learn/DataSection'
  ...
  render() {
    return (
        <div ref={this.homeRoot} className="home-root" 
          ...
          />
          <HeroNav visibleHeight={this.props.match.winDimen} />
          <DataSection visibleHeight={this.props.match.winDimen} />
          <FooterSection 
